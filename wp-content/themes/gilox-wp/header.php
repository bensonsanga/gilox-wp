      ...
      <nav class="menu" itemscope itemtype="https://schema.org/SiteNavigationElement">
		...
		<progress class="menu-article__progress js-menu-article-progress" max="7415" value="6415"></progress>
			...
			<a href="https://www.instagram.com/gilox.co" class="menu-main__link" data-category="Navigation" data-action="Header General (Main Menu)" itemprop="url">        <span itemprop="name">Instagram </span>
				...
				<li class="menu-main__item">
			<a href="https://www.twitter.com/Giloxco" class="menu-main__link" data-category="Navigation" data-action="Header General (Main Menu)" itemprop="url">        <span itemprop="name">Twitter</span>
			</a>    </li>
				<li class="menu-main__item">
			<a href="https://www.facebook.com/Gilox.co" class="menu-main__link" data-category="Navigation" data-action="Header General (Main Menu)" itemprop="url">        <span itemprop="name">Facebook</span>
			</a>    </li>
