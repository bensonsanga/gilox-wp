    ...
    <a href="<?php echo get_permalink() ?>" class="card-deity__link" itemprop="image" itemscope itemtype="<?php echo get_home_url(); ?>">
                        ...
                        <div class="card-deity__icon" itemprop="image" itemscope="" itemtype="https://schema.org/ImageObject">
                                ...
                                <?php if ( has_post_thumbnail() ) { ?>
                                    <img data-src="<?php echo the_post_thumbnail_url(); ?>" alt="Zeus, Greek King of the Gods" title="Zeus, Greek King of the Gods" class="card-deity__image lazyload" itemprop="url" loading="lazy" src="<?php echo the_post_thumbnail_url(); ?>"?q=75&amp;w=80&amp;auto=format">
                                    <?php
                                } else { ?>
